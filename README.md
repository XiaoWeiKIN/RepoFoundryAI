...
distribution upgrade, run this in each existing project and replace `0.8.5`
...
repofoundry --repo . upgrade --to 0.8.5
repofoundry --repo . upgrade --to 0.8.5 --governance-profile adaptive
repofoundry --repo . upgrade --to 0.8.5 --apply
...
RepoFoundry `0.8.5` uses Harness schema `3`, Harness Core `1.5.1`, Codex
...
`upgrade --to 0.8.5 --apply`. Earlier schema `3` Core and adapter contracts
